...
const popupInfo = [
  {
    ...
    year: '2015',
    popupPhoto: './images/popup/popup_one.png',
...
const projectInfo = [
  {
    ...
    backend: 'Back End Dev',
    year: '2015',
    popupPhoto: './images/snapshots/Snapshoot Portfolio.png',
...

  {
    ...
    backend: 'Back End Dev',
    year: '2015',
    popupPhoto: './images/snapshots/Snapshoot Portfolio 2.png',
    content: 'A daily selection of privately personalized reads; no accounts or sign-ups required.',
    tools: ['HTML', 'CSS', 'JavaScript'],
  },

  {
    ...
    backend: 'Back End Dev',
    year: '2015',
    popupPhoto: './images/snapshots/Snapshoot Portfolio 3.png',
    content: 'A daily selection of privately personalized reads; no accounts or sign-ups required.',
    tools: ['HTML', 'CSS', 'JavaScript'],
  },

  {
    ...
    backend: 'Back End Dev',
    year: '2015',
    popupPhoto: './images/snapshots/Snapshoot Portfolio 4.png',
    content: 'A daily selection of privately personalized reads; no accounts or sign-ups required.',
    tools: ['HTML', 'CSS', 'JavaScript'],
  },
];
...
<div class="card-body">
  ...
  <div>
    ...
    <ul class="card-sub">
      ...
      <div class="bullet-point"><img src="./images/icons/Counter.png" alt="Bullet Point"></div>
    ...
    popUp.innerHTML = `
        ...
        <div class="model-body">
          <div class="model-title">
            ...
            <i id="model-close" class="uil uil-multiply"><img src="./images/popup/cancel.png"></i>
            <ul class="card-sub">
